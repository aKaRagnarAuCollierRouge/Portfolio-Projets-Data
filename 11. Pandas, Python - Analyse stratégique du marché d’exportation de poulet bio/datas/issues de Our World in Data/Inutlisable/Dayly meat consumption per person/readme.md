# Daily meat consumption per person - Data package

This data package contains the data that powers the chart ["Daily meat consumption per person"](https://ourworldindata.org/grapher/daily-meat-consumption-per-person?tab=table&time=2010..2018&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website. It was downloaded on June 02, 2025.
